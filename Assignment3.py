# -*- coding: utf-8 -*-
"""
Created on Fri Oct 15 17:07:20 2021
...
def read_data_files(file_prefix, start_file_num, end_file_num):
    ...
    return dfFinal
data = read_data_files("Data_",6,50)
...
print('Most Active hour:', std_list.index(max(std_list)))# <----finds the day(index in std_list) that has the largest standard deviation of the acceleration magnitude
...
n, bins, patches = new_plot.hist(mag_list[std_list.index(max(std_list))], bins=bin_edges, density=False, facecolor='g', alpha=.85)
